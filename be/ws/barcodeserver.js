#!/usr/bin/env node
/**
 * Standalone Barcode WebSocket Server (ws/barcodeserver)
 * Run: node ws/barcodeserver.js  or  npm run barcode-server
 * Same logic as src/index.js; this file can be used for direct execution.
 */
...
server.listen(PORT, () => {
  console.log(`[barcodeserver] ws://0.0.0.0:${PORT} (allowed IP: ${ALLOWED_IP})`);
});
